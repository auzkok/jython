...
public class EncoderDerived extends Encoder implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public EncoderDerived(PyType subtype,PyObject[]args,String[]kwds) {
        super(subtype,args,kwds);
