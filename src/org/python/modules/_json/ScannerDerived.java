...
public class ScannerDerived extends Scanner implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public ScannerDerived(PyType subtype,PyObject context) {
        super(subtype,context);
